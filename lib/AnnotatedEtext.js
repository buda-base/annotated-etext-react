  ...
  */
  ...
  _createClass(AnnotatedEtext, [{
    ...
    value: function renderAnno(annotations) {
      ...
      var remaining = _toConsumableArray(Object.keys(annotations));
      ...
      while (nb > 0) {
        next = _toConsumableArray(remaining); //console.log("remaining",remaining,renderedAnno)
        ...
        try {
          for (var _iterator3 = remaining[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var k = _step3.value;
            var anno = annotations[k]; //console.log("anno",k,anno,remaining)
      ...
      var _arr = Object.keys(annotations);
          ...
          if (a.nb == 0) return _react.default.createElement("span", {
            ...
            return _react.default.createElement(_Tooltip.default, {
              title: _react.default.createElement("div", {
                id: "anno-tooltip"
              }, _react.default.createElement("div", null, " ", _this2.renderAnno(a.annotations), " "), _react.default.createElement("div", {
