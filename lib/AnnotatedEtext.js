  ...
  */
  ...
  _createClass(AnnotatedEtext, [{
    ...
    value: function render() {
      ...
      var ret = [_react.default.createElement("div", {
      ...
      }, _react.default.createElement("h3", null, "Annotation panel")), _react.default.createElement("div", {
        id: "annotatedEtext",
        ...
        return _react.default.createElement("div", {
          ...
          if (a.nb == 0) return _react.default.createElement("span", {
            ...
            "data-start": a.start,
            "data-end": a.end
          }, c.value.substring(a.start - c.start, a.end - c.start));else return _react.default.createElement(_Tooltip.default, {
            title: _react.default.createElement("div", {
              id: "anno-tooltip"
            }, _react.default.createElement("div", null, Object.keys(a.annotations).map(function (k) {
            ...
            interactive: true,
            classes: {
              tooltip: _this2.props.classes.lightTooltip
            },
            PopperProps: {
              style: {
                opacity: 1
            ...
            onClick: _this2.onAnnoClick.bind(_this2),
            className: "annotated",
            key: j,
            "data-seq": c.seq,
            "data-start": a.start,
                  ...
                  for (var _iterator4 = p.items[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    if (anno.target) {
                      ...
                      if (anno.target.type === "WorkLocation") {
                        ...
                        var target = anno.target; // can be recursive in target eg target.target...target
              ...
              try {
                for (var _iterator7 = tmp[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                  ...
                  if (idx != nxt) {
                    ...
                    if (body) _elem.annotations = _objectSpread({}, body);
