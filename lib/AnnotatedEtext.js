...
function (_Component) {
  ...
  */
  ...
  _createClass(AnnotatedEtext, [{
    ...
    key: "renderAnno",
    value: function renderAnno(a) {
      var _this2 = this;

      return Object.keys(a.annotations).map(function (k) {
        var anno = a.annotations[k];
        return _react.default.createElement("div", null, !anno.target && _react.default.createElement("h4", null, a.text), _react.default.createElement("span", {
          id: "anno-tooltip-span",
          className: a.annotations[k].motivation
        }, a.annotations[k].motivation === "identifying" && _react.default.createElement("span", null, _react.default.createElement("u", null, "identifying"), ": ", _this2.identifying(a.annotations[k].body)), a.annotations[k].motivation === "questioning" && _react.default.createElement("span", null, _react.default.createElement("u", null, "questioning"), ": ", _this2.questioning(a.annotations[k].body)), a.annotations[k].motivation === "replying" && _react.default.createElement("span", null, _react.default.createElement("u", null, "replying"), ":    ", _this2.replying(a.annotations[k].body))));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var ret = _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          ...
          if (a.nb == 0) return _react.default.createElement("span", {
            ...
            "data-start": a.start,
            "data-end": a.end
          }, c.value.substring(a.start - c.start, a.end - c.start));else {
            var anno = _this3.renderAnno(a);

            panel.push(_react.default.createElement("div", null, anno));
            return _react.default.createElement(_Tooltip.default, {
              title: _react.default.createElement("div", {
                id: "anno-tooltip"
              }, _react.default.createElement("div", null, " ", anno, " "), _react.default.createElement("div", {
              ...
              }, _react.default.createElement(_Announcement.default, null)), _react.default.createElement(_IconButton.default, {
                size: "small",
                title: "Reply",
                onClick: function onClick(e) {
                  return _this3.setState(_objectSpread({}, _this3.state, {
              ...
              }, _react.default.createElement(_QuestionAnswer.default, null)), _react.default.createElement(_IconButton.default, {
                size: "small",
                title: "Edit",
                onClick: function onClick(e) {
                  return _this3.setState(_objectSpread({}, _this3.state, {
      ...
      }, _react.default.createElement("h3", null, "Annotation panel"), panel));
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.services) {
        ...
        try {
          for (var _iterator3 = props.services[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            for (var _i = 0; _i < _arr.length; _i++) {
              ...
              for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
                ...
                try {
                  for (var _iterator4 = p.items[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      if (props.chunks && (!state.chunks || annoInfo.length !== state.numAnno || props.chunks.length !== state.chunks.length)) {
        ...
        try {
          var _loop = function _loop() {
            ...
            try {
              for (var _iterator6 = annoInfo[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                var _anno = _step6.value;
            ...
            if (annoList.length > 0) {
              ...
              try {
                for (var _iterator7 = tmp[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                  var a = _step7.value;
                  ...
                  if (idx != nxt) {
                    ...
                    if (body) {
                      _elem.annotations = _objectSpread({}, body);
                      _elem.text = chunk.value.substring(idx - chunk.start, nxt - chunk.start);
                    }
          ...
          for (var _iterator5 = props.chunks[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            _loop();
          }
        } catch (err) {
