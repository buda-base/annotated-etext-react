      ...
      */
      ...
      if (this.state.annotations && this.state.newAnno) {
        ...
        if (anno.length > 0 && !anno.motivation) {
          ...
          newState = _objectSpread({}, this.state, {
            annotations: this.state.annotations.filter(function (a) {
              return a.id != _this2.state.newAnno;
            })
          });
          delete newState["newAnno"]; //return newState
      ...
      var ret = _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          ...
          if (a.nb == 0) return _react.default.createElement("span", {
            ...
            console.log("a.anno", _this3.state.newAnno && a.annotations && a.annotations[_this3.state.newAnno], a.annotations, a.annotations[_this3.state.newAnno], _this3.state.newAnno);
            return _react.default.createElement(_Tooltip.default, _extends({
              id: "tip-" + Math.random().toString(36).substr(2, 9)
            }, _this3.state.newAnno && a.annotations && a.annotations[_this3.state.newAnno] ? {
              open: true
            } : {}, {
