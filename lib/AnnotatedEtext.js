  ...
  */
  ...
  _createClass(AnnotatedEtext, [{
    ...
    value: function renderAnno(annotations) {
      ...
      var remaining = _toConsumableArray(Object.keys(annotations).filter(function (k) {
        return !annotations[k].collection || _this2.props.showCollections[annotations[k].collection];
      }).map(function (k) {
        return {
          k: k,
      ...
      try {
        ...
        if (fromChunk && toChunk) {
          ...
          if (!isNaN(startChar) && !isNaN(endChar) && startChar !== endChar) {
            ...
            if (!newState) newState = _objectSpread({}, this.state);
            newState = _objectSpread({}, newState, {
              /*annoPanel:true,*/
              newAnno: "tmp:test" + _id,
              annotations: _toConsumableArray(newState.annotations).concat([{
                startChar: startChar,
                endChar: endChar,
                //motivation:"identifying",
                body: {
                  "rdfs:comment": {
                    "@language": "en",
                    "@value": "This is test annotation #" + _id
                  },
                  id: "tmp:test" + _id
                },
                id: "tmp:test" + _id
    ...
    value: function render() {
      ...
      var ret = _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          ...
          console.log("a", a, c);
          if (a.nb == 0 || Object.keys(a.annotations).filter(function (k) {
            return !a.annotations[k].collection || _this3.props.showCollections[a.annotations[k].collection];
          }).length === 0) return _react.default.createElement("span", {
            key: j,
            "data-seq": c.seq,
            "data-start": a.start,
            "data-end": a.end
            ...
            return _react.default.createElement(_Tooltip.default //id={tipid}
            ...
            , {
              title: _react.default.createElement("div", {
                ...
                size: "small",
                title: "Search in BDRC Public Digital Library"
                /* onClick={ e => this.setState({...this.state,annoPanel:true})} */
        ...
        try {
          for (var _iterator5 = props.services[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
              var _id2 = _arr2[_i2];
              var pages = service.collectionsById[_id2].pages;
          ...
          try {
            var _loop = function _loop() {
              ...
              if (annoList.length > 0) {
                var tmp = annoList.filter(function (e) {
                  return !e.collection || props.showCollections[e.collection];
