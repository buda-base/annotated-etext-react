  ...
  */
  ...
  _createClass(AnnotatedEtext, [{
    ...
    value: function renderAnno(a) {
      var remaining = _toConsumableArray(Object.keys(a.annotations));
      ...
      while (nb > 0) {
        ...
        try {
          for (var _iterator3 = remaining[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            var newAnno = [];
            if (!anno.target) newAnno.push(_react.default.createElement("h4", null, a.text));
      ...
      var _arr = Object.keys(a.annotations);

      for (var _i = 0; _i < _arr.length; _i++) {
        var _k = _arr[_i];
        if (!a.annotations[_k].target) ret.push(renderedAnno[_k]);
      }
          ...
          if (a.nb == 0) return _react.default.createElement("span", {
            ...
            return _react.default.createElement(_Tooltip.default, {
              title: _react.default.createElement("div", {
                ...
                href: "http://library.bdrc.io/search?q=\"" + a.text + "\"&lg=" + c.lang + "&t=Any",
                target: "_blank"
              ...
              }, _react.default.createElement(_Build.default, null)), _react.default.createElement(_IconButton.default, {
                size: "small",
                title: "Delete",
                onClick: function onClick(e) {
                  return _this2.setState(_objectSpread({}, _this2.state, {
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.services) {
        ...
        try {
          for (var _iterator4 = props.services[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
              ...
              for (var _i3 = 0; _i3 < _arr3.length; _i3++) {
                ...
                try {
                  for (var _iterator5 = p.items[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      if (props.chunks && (!state.chunks || annoInfo.length !== state.numAnno || props.chunks.length !== state.chunks.length)) {
        ...
        try {
          var _loop = function _loop() {
            ...
            try {
              for (var _iterator7 = annoInfo[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                var _anno = _step7.value;
            ...
            if (annoList.length > 0) {
              ...
              try {
                for (var _iterator8 = tmp[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                  var a = _step8.value;
          ...
          for (var _iterator6 = props.chunks[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            _loop();
          }
        } catch (err) {
