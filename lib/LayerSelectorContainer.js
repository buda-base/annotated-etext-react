...
function (_React$Component) {
  ...
  _createClass(LayerSelector, [{
    ...
    value: function render() {
      var res = _react.default.createElement("div", null, _react.default.createElement("h3", null, "Annotation layer selector"), " ", this.props.services && this.props.services.map(function (service) {
        return _react.default.createElement(_LayerServiceList.default, null);
      }));
