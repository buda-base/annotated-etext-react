...
function (_React$Component) {
  ...
  function LayerServiceList() {
    _classCallCheck(this, LayerServiceList);

    return _possibleConstructorReturn(this, _getPrototypeOf(LayerServiceList).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      var res = _react.default.createElement("div", null, this.props.service && Object.keys(this.props.service.collectionsById).map(function (id, i) {
        return _react.default.createElement("a", {
          key: i,
          href: "#"
        }, _this.props.service.collectionsById[id]["collectionInfo"]["collection"]["label"]["@value"]);
      }));
...
var LayerServiceListContainer = (0, _reactRedux.connect)(mapStateToProps)(LayerServiceList);
