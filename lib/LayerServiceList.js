    ...
    value: function checkSync(nextProps) {
      ...
      if (nextProps.service && nextProps.service.collectionsById) {
        ...
        for (var _i = 0; _i < _arr.length; _i++) {
          var id = _arr[_i];
          var collec = nextProps.service.collectionsById[id];

          if (collec.shouldSyncFor.start > collec.syncedFor.end && !collec.fetching) {
            this.props.onSyncService("http://purl.bdrc.io/anncollection/" + id.replace(/bdac:/, "") + "/pageForRange", collec.shouldSyncFor); // wait for collection to sync before re-render
    ...
    value: function render() {
      ...
      var res = _react.default.createElement("div", null, this.props.service && Object.keys(this.props.service.collectionsById).map(function (id, i) {
        return _react.default.createElement("a", {
          key: i,
          href: "#"
        }, _this2.props.service.collectionsById[id]["collectionInfo"]["collection"]["label"]["@value"]);
      }));
